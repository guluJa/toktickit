...
describe("Staff Ticket Queue", () => {
  ...
  it("passes the selected ticket id to Staff Ticket Detail navigation", async () => {
    const user = userEvent.setup(); const onOpenTicket = vi.fn();
    render(<StaffTicketQueue role="IT_STAFF" onOpenTicket={onOpenTicket} />);
